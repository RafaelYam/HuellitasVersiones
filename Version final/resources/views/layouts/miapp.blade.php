...
<body class="font-sans antialiased">
                    ...
                    <div class="w-full">
                        <div class="items-end justify-between block mb-8 footer-logo-support md:flex">
                            <div class="flex items-end footer-logo">
                                <a class="mt-8" href="index.html"><img src="http://assets.stickpng.com/thumbs/58aeffe0c869e092af51ee77.png"  width="55" alt="Logo"></a>
                ...
                <div class="row">
                    ...
                    <div class="w-full sm:w-7/12 md:w-1/2 lg:w-1/3">
                        <div class="mb-8 footer-newsletter">
                            <h6 class="footer-title">Suscribete y recibe notificaciones de actividas o productos para tu mascota:</h6>
                            <div class="newsletter">
                                <form action="#" class="relative mb-4">
                                    <input type="text" placeholder="ejemplo@email.com" class="w-full py-3 pl-6 pr-12 duration-300 bg-gray-200 border border-gray-200 rounded-full focus:border-blue-600 focus:outline-none">
  ...
  <script>
    ...
    <a class="back-to-top" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
