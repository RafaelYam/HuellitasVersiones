...
class MascotaController extends Controller
{
    ...
    public function editar($id)
    {
        ...
        $razas=Raza::where('animal_id',$mascota->animal_id)->get();
        $animals=Animal::All();
        //dd($razas);
        return view('CRUDMascota.edit',['mascota'=>$mascota,'razas'=>$razas,'animals'=>$animals]);
    }


    public function registroid($id)
    {
        
  
        $razas=Raza::find($id);
        
        $animals=Animal::find($razas->animal_id);
        return view('CRUDMascota.anadirid',['razas'=>$razas,'animals'=>$animals]);
    }
