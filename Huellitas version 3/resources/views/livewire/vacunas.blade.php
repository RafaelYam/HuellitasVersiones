<div>
    ...
    <section id="service" class="relative services-area py-120 container">
        <h4 class="title">Vacunas que necesita mascota!</h4>
        <div class="grid grid-cols-6 gap-4">

            <div class="col-start-1 col-end-3">
                @foreach($vacunas as $vacuna)
                <ul class="py-3"><button class="relative px-6 py-3 group "  wire:click="activar({{$vacuna->id}})">
                        ...
                        <span class="relative text-cyan-700 group-hover:text-cyan-100"> {{$vacuna->nombre}}</span>
                    </button></ul>
                @endforeach
