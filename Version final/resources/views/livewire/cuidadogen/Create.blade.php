<div class="grid grid-cols-6 gap-4">
    ...
    <form>
        <div class="form-group">
            ...
            <input type="text" class="form-control block w-full px-3 py-1.5 text-base
      font-normal
      text-gray-700
